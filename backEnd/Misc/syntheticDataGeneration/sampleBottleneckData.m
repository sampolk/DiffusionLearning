function [X,Y] = sampleBottleneckData( std_g,  width_u, height_u,separation, n_g, n_u, max_spl)
...
% ============================= Collect Data  =============================
        ...
        G = extractGraph(X, Hyperparameters);

        if G.EigenVals(2)<1 

            Clusterings = MLUND(X, Hyperparameters);
